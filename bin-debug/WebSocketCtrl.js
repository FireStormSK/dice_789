 ...
 */
var WebSocketCtrl = (function (_super) {
    __extends(WebSocketCtrl, _super);
    function WebSocketCtrl() {
        _super.call(this);
        this.i = 0;
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=WebSocketCtrl,p=c.prototype;
    p.onAddToStage = function (event) {
        //设置加载进度界面
        this.WebSocketInit();
    };
    p.WebSocketInit = function () {
        this.i++;
        //     this.post();
        //登入
        ...
        var UrlStr = " ws://139.129.46.227:8080/f2f/ws/dice/" + Main.TABLE + "/" + Main.ME.Name;
    ...
    WebSocketCtrl.inited = false;
    return WebSocketCtrl;
})(egret.Sprite);
egret.registerClass(WebSocketCtrl,'WebSocketCtrl');
